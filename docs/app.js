...
/* ===== V1.2.39 - Graficos barra compactos ===== */
...
/* ===== V1.2.39 - Reaseguro gráficos barra compactos ===== */
...
/* ===== V1.2.39 - Dashboard 4 gráficos + últimas alertas compactas ===== */
...
/* ===== V1.2.39 - SOLO vista Tránsitos: tarjeta como imagen ===== */
...
/* ===== V1.2.39 - Localidad/provincia desde coordenadas conocidas ===== */
...
/* ===== V1.2.39 - SOLO vista Seguimiento: mapa real GPS ===== */
...
/* ===== V1.2.39 - Seguimiento: fix mapa y localidad/provincia ===== */
function trackingCard(t){
  let o=openT(t),r=ruta(t),pos=getPosObj(t);
...
/* ===== V1.2.39 - Seguimiento: zoom a todas las flotas en transito + marcador con numero ===== */
...
/* ===== V1.2.39 - Seguimiento: marcador numerico estilo etiqueta ===== */
...
/* ===== V1.2.39 - Seguimiento: solo numero, zoom con todas las flotas, ultimo reporte resaltado ===== */
...
/* ===== V1.2.39 - Seguimiento: filtros cliente/embarque + marker 50% ===== */
...
/* ===== V1.2.39 - Solo transitos abiertos + Unidades/Choferes por usuarios role=flota ===== */
...
/* ===== V1.2.39 - Unidades / Choferes: usuarios role flota flexible ===== */
...
/* ===== V1.2.39 - Correcciones Transitos y Unidades / Choferes ===== */
...
/* ===== V1.2.39 - Fix filtros Unidades / Choferes + Tractor/Batea ===== */
...
/* ===== V1.2.39 - Dashboard y Tránsitos muestran abiertos + finalizados ===== */
...
/* Dashboard: tabla últimos tránsitos con abiertos + finalizados */
function renderDashTable(){
  if(!q("dashTable"))return;
  let rows = trs.slice()
    .sort((a,b)=>tv(transitUpdatedValue(b))-tv(transitUpdatedValue(a)))
...
/* ===== V1.2.39 - Clientes / Destinos sin JSON visible ===== */
...
/* ===== V1.2.39 - Fix render Clientes / Destinos ===== */
...
/* ===== V1.2.39 - Fix campo Tractor desde usuarios.tractor ===== */
...
/* ===== V1.2.39 - Clientes contacto/telefono + Destinos horarios/coordenadas ===== */
...
/* ===== V1.2.39 - Destinos solo desde coleccion destinos + contacto/telefonos ===== */
...
/* ===== V1.2.39 - Alertas con estado verificada/pendiente ===== */
...
/* ===== V1.2.39 - Render destinos sin texto Activo/Inactivo ===== */
...
/* ===== V1.2.39 - Alertas: graficos con cantidad/% y boton funcional ===== */
...
/* ===== V1.2.39 - Render clientes sin texto Activo/Inactivo ===== */
...
/* ===== V1.2.39 - Alertas: fix contador, KM y detalle ===== */
...
/* ===== V1.2.39 - Alertas: iconos por tipo y mejora visual ===== */
...
/* ===== V1.2.39 - Clima: carga de datos + iconos por tarjeta ===== */
...
/* ===== V1.2.39 - Clima real Open-Meteo por coordenadas ===== */
...
/* ===== V1.2.39 - Clima: layout, temp con icono, GPS real flotas abiertas ===== */
...
/* ===== V1.2.39 - Clima: clase destino + fix menú ===== */
...
/* ===== V1.2.39 - Normalizar item Clima en menu lateral ===== */
